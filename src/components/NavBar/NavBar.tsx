        ...
        <div className="nav">
            <div className="upper">
                ...
                <div className="nav-search">
                    <input type="text" className="search-bar" onChange={handleInputChange} placeholder="Pretrazi prema nazivu proizvoda"/>
                    <Link to={`/shop/${inputValue}`}><svg onClick={handleButtonClick}  xmlns="http://www.w3.org/2000/svg" className="lupa" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
